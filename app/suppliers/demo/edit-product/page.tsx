    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-blue-600 text-white p-3 text-center">
        <p className="text-sm font-medium">
          This is a demo supplier account. In a real account, you would be editing your actual products.
        </p>
      </div>
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full">
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-lg font-bold mb-2">Product Updated Successfully!</h3>
              <p className="text-gray-600 mb-4">Your product "{productName}" has been updated.</p>
              <div className="flex gap-3">
                <Button variant="outline" onClick={() => router.push("/suppliers/demo/edit-product")}>
          ...
          <div className="lg:w-80 space-y-6">
            ...
            <div className="bg-blue-50 p-6 rounded-lg border border-blue-100">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-sm font-medium text-blue-800 mb-2">Product History</h3>
                  <ul className="text-xs text-blue-700 space-y-1">
                    <li>Created: April 15, 2025</li>
                    <li>Last updated: May 1, 2025</li>
                    <li>Views: 342</li>
                    <li>Conversions: 18.5%</li>
                  </ul>
                </div>
              </div>
            </div>
